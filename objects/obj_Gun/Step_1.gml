...
if ( (mouse_check_button(mb_left)) /*|| gamepad_button_check(4, gp_shoulderrb)*/)  && (firingdelay < 0) {
	...
	with (obj_Player)
	{
		...
		/*
		-Set gunkickx the x-component of a triangle. That's how lengthdir_x()
		works. We're moving 1.5px in the opposite direction of the image's
		current angle. This is the opposite due to the -180.
		
		-This is the same thing for gunkicky. Only thing we changed was for
		the kickback to be only 1px.
		*/
	}
}
